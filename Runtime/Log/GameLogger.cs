namespace Darkness.Runtime.Log {
    ...
    public class GameLogger {
        ...
        public void Log(object message) {
            if (_currentLogLevel >= LogLevel.Info) Debug.Log(message);
        }
        ...
        public void Log(object message, UnityEngine.Object context) {
            if (_currentLogLevel >= LogLevel.Info) Debug.Log(message, context);
        }
        ...
        public void Warning(object message) {
            if (_currentLogLevel >= LogLevel.Warning) Debug.LogWarning(message);
        }
        ...
        public void Warning(object message, UnityEngine.Object context) {
            if (_currentLogLevel >= LogLevel.Warning) Debug.LogWarning(message, context);
        }
        ...
        public void Error(object message) {
            if (_currentLogLevel >= LogLevel.Error) Debug.LogError(message);
        }
        ...
        public void Error(object message, UnityEngine.Object context) {
            if (_currentLogLevel >= LogLevel.Error) Debug.LogError(message, context);
        }
        ...
        public void Exception(Exception exception) {
            if (_currentLogLevel >= LogLevel.Error) Debug.LogException(exception);
        }
        ...
        public void Exception(Exception exception, UnityEngine.Object context) {
            if (_currentLogLevel >= LogLevel.Error) Debug.LogException(exception, context);
        }
        ...
        public void Assert(bool condition, object message = null) {
            if (_currentLogLevel >= LogLevel.Error) Debug.Assert(condition, message);
        }
        ...
        public void Assert(bool condition, object message, UnityEngine.Object context) {
            if (_currentLogLevel >= LogLevel.Error) Debug.Assert(condition, message, context);
        }
        ...
        public void LogFormat(string format, params object[] args) {
            if (_currentLogLevel >= LogLevel.Info) Debug.LogFormat(format, args);
        }
        ...
        public void LogFormat(UnityEngine.Object context, string format, params object[] args) {
            if (_currentLogLevel >= LogLevel.Info) Debug.LogFormat(context, format, args);
        }
        ...
        public void WarningFormat(string format, params object[] args) {
            if (_currentLogLevel >= LogLevel.Warning) Debug.LogWarningFormat(format, args);
        }
        ...
        public void WarningFormat(UnityEngine.Object context, string format, params object[] args) {
            if (_currentLogLevel >= LogLevel.Warning) Debug.LogWarningFormat(context, format, args);
        }
        ...
        public void ErrorFormat(string format, params object[] args) {
            if (_currentLogLevel >= LogLevel.Error) Debug.LogErrorFormat(format, args);
        }
        ...
        public void ErrorFormat(UnityEngine.Object context, string format, params object[] args) {
            if (_currentLogLevel >= LogLevel.Error) Debug.LogErrorFormat(context, format, args);
        }
